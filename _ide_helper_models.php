 ...
 * @property string|null $description Содержание категории
 ...
 * @property string $title Заголовок
 * @property string|null $author Автор новости
 * @property string|null $image Картинка новости
 * @property string $status Выбор статуса из имеющихся
 * @property string|null $description Содержание новости
 * @property int $isActive Активно или НЕ активно
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
